    ...
    return (
        <Transition.Root show={open} as={Fragment}>
            ...
            &#8203;
                    ...
                    >
                        <div style={{alignSelf:'center'}} className="z-50 inline-block align-bottom bg-gray-800 rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
